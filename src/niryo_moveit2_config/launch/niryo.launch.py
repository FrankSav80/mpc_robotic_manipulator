...
from launch.actions import DeclareLaunchArgument, TimerAction # AGGIUNTO TimerAction - per nodo lin_traj_chomp
...
def generate_launch_description():
    ...
    # AGGIUNGO
    # Nodo lin_traj_chomp
    lin_traj_chomp_node = Node(
        package="niryo_moveit2_config",
        executable="lin_traj_chomp",
        output="screen",
        parameters=[
    ...
    # Avvia il nodo lin_traj_chomp dopo un ritardo di 30 secondi
    delayed_lin_traj_chomp_node = TimerAction(
        period=30.0,  # Ritardo di 30 secondi
        actions=[lin_traj_chomp_node],
    )
    ...
    return LaunchDescription(
        [
            ...
            delayed_lin_traj_chomp_node,  # AGGIUNTO - lin_traj_chomp ritardato
        ]
    )
